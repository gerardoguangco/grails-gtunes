...
<div id="list-store" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <th><g:message code="store.album.label" default="Album"/></th>
        ...
        <g:each in="${storeInstanceList}" status="i" var="storeInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                <td><g:link action="show"
                            id="${storeInstance.id}">${fieldValue(bean: storeInstance, field: "title")}</g:link></td>
                <td>${fieldValue(bean: storeInstance, field: "album")}</td>
            </tr>
        </g:each>
        </tbody>
    </table>
